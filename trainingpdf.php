...
$topiclist = '';
  ...
  while ($row = $dataset->fetch_assoc()) {
    ...
    $trainingDate = substr($row["training_date"], 0, -3);
  ...
  while ($row = $data->fetch_assoc()) {
    ...
    $divAttendee .= '<div class="column">
                        <div style="margin-left: 72px;border-bottom: 1px solid #000; bottom:23px;">
                          <span style="font-style:normal;font-weight:normal;font-size:9pt;font-family:Calibri;color:#000000;"> '.$crtAttendee.'. </span> <span style="width: 200px; border-width: thin;font-style:normal;font-weight:normal;font-size:11pt;font-family:Calibri;color:#000000;">
                        '.$firstName.'
                          </span>
                          </div>
                    </div>
...
for($i = 0; $i< count($arrTrainig); $i++) {
    ...
    $div .= '<div class="column">
                  <div style="margin-left: 72px;border-bottom: 1px solid #000; bottom:23px;"> <span style="font-style:normal;font-weight:normal;font-size:11pt;font-family:Calibri;color:#000000;"> '.$ctr.'. </span> <span style="width: 200px; border-width: thin;font-style:normal;font-weight:normal;font-size:11pt;font-family:Calibri;color:#000000;">
                  '.$arrTrainig[$i].'
                  </span></div>
              </div>'; 
          }
...
<div style="position:absolute;top:2.23in;left:4.2in;width:8.86in;line-height:0.17in;">
...
<div class="trainer" width="150" style="text-align:center;border-bottom: 1px solid #000;position:absolute;top:2.52in;left:4.43in;line-height:0.17in;">
  <span style="font-style:normal;font-weight:normal;font-size:11pt;font-family:Calibri;color:#000000">{$trainingDate}</span>
</div> 
